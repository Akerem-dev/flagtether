...
public class FeatureFlagEvaluationService {
  ...
  public FeatureFlagEvaluationService(
      FeatureFlagService featureFlagService, TargetingRuleService targetingRuleService) {
  ...
  public FeatureFlagEvaluation evaluate(
    ...
    List<TargetingRule> rules =
        targetingRuleService.getRules(flag.getName(), flag.getEnvironment());
  ...
  private String getContextValue(
      String attribute, String userKey, String country, String plan, String email) {
  ...
  private int calculateBucket(String environment, String flagName, String userKey) {

    String input = environment + ":" + flagName + ":" + userKey;
  ...
  private void validateUserKey(String userKey) {
    ...
    if (userKey == null || userKey.isBlank()) {
      ...
      throw new IllegalArgumentException("userKey bos olamaz.");
    }
  }
}
