...
public class TargetingRuleService {
    ...
    public TargetingRule create(
        ...
        TargetingOperator parsedOperator =
                parseOperator(
                        operator
                );
    ...
    public void delete(
        ...
        if (!deleted) {
            ...
            throw new TargetingRuleNotFoundException(
                    ruleId
            );
        }
    ...
    private TargetingOperator parseOperator(
            String operator
    ) {
        ...
        try {
            ...
            return TargetingOperator.valueOf(
                    operator
                            .trim()
                            .toUpperCase(
                                    Locale.ROOT
