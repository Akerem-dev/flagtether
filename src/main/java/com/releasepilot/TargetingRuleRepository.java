...
public TargetingRuleRepository(
...
private Connection openConnection()
    ...
    public TargetingRule insert(
        ...
        try (
            ...
            throw new RuntimeException(
                    "Targeting rule database'e eklenemedi.",
                    exception
            );
        }
    }
    ...
    public List<TargetingRule> findAll(
        ...
        try (
            ...
            throw new RuntimeException(
                    "Targeting rule'lar database'den okunamadi.",
                    exception
            );
        }
    }
