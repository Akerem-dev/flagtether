...
public class TargetingRule {
    ...
    public TargetingRule(
        ...
        if (
            ...
            throw new IllegalArgumentException(
                    "Rule comparisonValue bos olamaz."
            );
        }
        ...
        if (
                !normalizedAttribute.equals("userkey")
